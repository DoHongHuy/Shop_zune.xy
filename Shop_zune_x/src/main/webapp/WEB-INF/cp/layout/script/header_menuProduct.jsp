    ...
    <nav>
        <div class="text-center menu-wrap">
            <ul class="list-unstyled main-nav list-inline">
                <li>
                    <a href="/products?action=create" target="_self" title="Bộ Sưu Tập">Thêm sản phẩm</a>
                </li>
                <li class="list-unstyled">
                    <a href="/products" target="_self" title="Tất cả sản phẩm">Tất cả sản phẩm</a>
...
<%--                    </ul>--%>
                ...
                <li>
                    <a href="https://zunezx.com/ve-chung-toi.html" target="_self" title="Về chúng tôi">Về chúng
                        tôi</a>
                </li>
                <li>
                ...
                <li class="hidden-xs header-account-link">
                    <a href="https://zunezx.com/tai-khoan.html" title="Tài khoản"><img class="icon-in-menu"
                                                                                       src="https://zunezx.com/public/home/img/w-account.png"
                                                                                       alt="Tài khoản"></a>
                </li>
                <li class="hidden-xs">
                    <a href="https://zunezx.com/gio-hang.html" title="Giỏ hàng" class="header-cart"><img
