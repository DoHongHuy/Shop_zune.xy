...
<header>
    ...
    <div class="logo text-center hidden-xs">
        <a href="/homePage" title="Zune.zx - Unisex"><img
                src="/homePage" title="Zune.zx - Unisex"
            ...
            <ul class="list-unstyled main-nav list-inline">
                ...
                <li class="list-unstyled">
                    ...
                    <ul class="list-unstyled">
                        <li>
                            <a href="https://zunezx.com/san-pham-sale.html" target="_self" title="Giảm giá">Giảm
                                giá</a>
                        </li>
                        <li class="has-sub">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li>
                                    <a href="https://zunezx.com/shirts-cp132" target="_self"
                                       title="Shirts">Shirts</a>
                                </li>
                                <li>
                        ...
                        <li>
                            <a href="https://zunezx.com/combat-boots-cp170" target="_self"
                               title="COMBAT BOOTS">COMBAT BOOTS</a>
                        </li>
                        <li>
                            <a href="https://zunezx.com/set-phoi-san-cp152" target="_self" title="SET PHỐI SẴN">SET
                                PHỐI SẴN</a>
                        </li>
                        <li>
                ...
                <li>
                    <a href="huong-dan-dat-hang-i14.html" target="_self" title="Hướng dẫn mua hàng ">Hướng dẫn mua
                        hàng </a>
                </li>
                <li>
                    <a href="   " target="_self" title="Về chúng tôi">Về chúng
                        tôi</a>
                </li>
                <li>
                    <a href="" target="_self" title="Tin tức">Tin tức</a>
                </li>
                ...
                <li class="hidden-xs header-account-link">
                    <a href="/login?action=deleteCoki" title="Tài khoản"><img class="icon-in-menu"
                                                                                       src="https://zunezx.com/public/home/img/w-account.png" alt="Tài khoản"></a>
                </li>
                <li class="hidden-xs">
                    <a href="" title="Giỏ hàng" class="header-cart"><img
                            class="icon-in-menu" src="https://zunezx.com/public/home/img/w-shop.png"
                            alt="Giỏ hàng"></a>
                </li>
            </ul>
        </div>
